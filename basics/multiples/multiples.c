...
int i,j; /* In a larger program it would benificial to set both a global and a local variable for counters. This program wouldn't be big enough to benifit from that. */
